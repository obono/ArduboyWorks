...
PROGMEM static const uint8_t imgSubTitle[60] = { // 60x8
    0x86, 0x89, 0x89, 0x91, 0x60, 0x00, 0x60, 0x94, 0x94, 0x94, 0xF8, 0x80, 0x00, 0xFC, 0x08, 0x04,
    0x04, 0xF8, 0x08, 0x04, 0x04, 0xF8, 0x00, 0x78, 0x94, 0x94, 0x94, 0x98, 0x00, 0x3C, 0x42, 0x81,
    0x81, 0x81, 0x81, 0xF1, 0x00, 0x60, 0x94, 0x94, 0x94, 0xF8, 0x80, 0x00, 0xFC, 0x08, 0x04, 0x04,
    0xF8, 0x08, 0x04, 0x04, 0xF8, 0x00, 0x78, 0x94, 0x94, 0x94, 0x98, 0x00
};
...
void initTitle(void)
{
    ...
    setMenuItemPos(0);
    setMenuCoords(28, 46, 71, 18, false, true);
    state = STATE_TITLE;
    isInvalid = true;
}
...
static void drawTitleImage(void)
{
    ...
    arduboy.drawBitmap(34, 30, imgSubTitle, IMG_SUBTITLE_W, IMG_SUBTITLE_H, WHITE);
#ifdef DEBUG
    arduboy.printEx(98, 32, F("DEBUG"));
#endif
